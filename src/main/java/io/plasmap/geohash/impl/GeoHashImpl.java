 ...
 ******************************************************************************/
package io.plasmap.geohash.impl;
...
public class GeoHashImpl {
	...
	public static enum PRECISION {
		...
		YOTTA_LOW_4BIT(2),
		YOTTA_LOW_6BIT(3),
		YOTTA_LOW_8BIT(4), //old old precision

		ULTRA_LOW_630KM(5),
		ULTRA_LOW_12BIT(6),//old precision
		ULTRA_LOW_14BIT(7),

		VERY_LOW_80KM(8),//old old precision---------------
		VERY_LOW_18BIT(9),

		LOW_20KM(10),//old old precision------------
		LOW_22BIT(11),
		LOW_24BIT(12),//old precision


		MEDIUM_5KM(13),//old old precision------
		MEDIUM_28BIT(14),
		MEDIUM_30BIT(15),
		MEDIUM_32BIT(16),
		MEDIUM_34BIT(17),

		HIGH_100M(18),//old old  precision-------------
		HIGH_38BIT(19),
		HIGH_40BIT(20),
		HIGH_42BIT(21),
		HIGH_44BIT(22),
		...
		VERY_HIGH_1M(24),//old old precision-----------------
		VERY_HIGH_50BIT(25),
		VERY_HIGH_52BIT(26),
		VERY_HIGH_54BIT(27),
		VERY_HIGH_56BIT(28),
		...
		ULTRA_1CM(30),//old old precision
		ULTRA_62BIT(31),

		ULTRA_HIGH_1MM(32);//old old precision
