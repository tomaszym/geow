...
import io.plasmap.serializer.OsmDenormalizedSerializerOld
import io.plasmap.util.Denormalizer
...
class DenormalizerSpec extends Specification with ScalaCheck {
  ...
  "The Denormaliser" should {
    ...
    "denormalise a simplified version of relation http://osm.org/relation/1373904 correctly" in {
      ...
      val geoWays  = denWays.map(w ⇒ Bijections.denormalizedToGeoJson(w))
      val geoRels  = Bijections.denormalizedToGeoJson(denRel)
      OsmDenormalizedSerializerOld.toGeoJsonString(denRel).trim() must beEqualTo("""{"type":"Feature","geometry":{"type":"GeometryCollection","geometries":[{"type":"MultiPolygon","coordinates":[[[[6.7245784,51.1707285],[6.7233803,51.1706678],[6.723407,51.1710139],[6.7244427,51.1711302],[6.7245784,51.1707285]],[[6.7239214,51.1709826],[6.7239349,51.1709197],[6.7240489,51.1709293],[6.7240353,51.1709922],[6.7239214,51.1709826]],[[6.7239052,51.1708848],[6.7238241,51.1708764],[6.7238433,51.1708029],[6.7239245,51.1708112],[6.7239052,51.1708848]]]]}]},"properties":{"_osm_version_changeset":"1","_osm_id":"1373904","_osm_type":"relation","_osm_version_visible":"true","_osm_version_timestamp":"1","_osm_user_id":"None","_osm_user_name":"None"}}""")
    }
    ...
    OsmDenormalizedSerializerOld.toGeoJsonString(denRels) must beEqualTo("""{"features":[{"type":"feature","geometry":{"type":"geometrycollection","geometries":[{"type":"multipolygon","coordinates":[[[[17.0,16.0],[16.0,16.0],[16.0,15.0],[17.0,15.0],[17.0,16.0]]]]}]},"properties":{"_osm_version_changeset":"1","_osm_id":"1","_osm_type":"relation","_osm_version_visible":"true","_osm_version_timestamp":"1","_osm_user_id":"none","_osm_user_name":"none"}},{"type":"feature","geometry":{"type":"geometrycollection","geometries":[{"type":"multipolygon","coordinates":[[[[6.0,5.0],[7.0,5.0],[7.0,6.0],[6.0,6.0],[6.0,5.0]]],[[[0.0,5.0],[7.0,0.0],[12.0,3.0],[11.0,10.0],[4.0,11.0],[0.0,5.0]],[[3.0,5.0],[7.0,2.0],[10.0,5.0],[6.0,10.0],[3.0,5.0]]]]}]},"properties":{"_osm_version_changeset":"1","_osm_id":"0","_osm_type":"relation","_osm_version_visible":"true","_osm_version_timestamp":"1","_osm_user_id":"none","_osm_user_name":"none"}}]}""").ignoreCase.ignoreSpace
    }
  }
