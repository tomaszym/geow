...
//      val geoJson = Feature(io.plasmap.geojson.Point((0.9999999823048711, 1.9999999855645)),
...
//      val geoJson = Feature(LineString(List((0.9999999823048711, 1.9999999855645), (2.000000006519258, 0.9999999613501132))),
//        Map("_osm_version_changeset" -> "1",
//          "_osm_id" -> "12",
//          "_osm_user_id" -> "9",
//          "_osm_user_name" -> "fred",
