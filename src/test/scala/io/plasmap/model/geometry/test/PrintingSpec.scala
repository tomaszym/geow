package io.plasmap.model.geometry.test

import io.plasmap.model.geometry.{LineString, Point}
import io.plasmap.model.{OsmDenormalizedRelation, OsmDenormalizedWay, OsmDenormalizedNode}
